                            ...
                            <tr>
                                ...
                                <td>
                                      <label for="inline-radio1" class="form-check-label "style = "margin: 20px" >
                                        <input type="radio" name="radios1" class="form-check-input">Sangat puas
                                      </label>

                                      <label for="inline-radio2" class="form-check-label "style = "margin: 20px">
                                        <input type="radio" name="radios1" class="form-check-input">Puas
                                      </label>

                                      <label for="inline-radio3" class="form-check-label "style = "margin: 20px">
                                        <input type="radio" name="radios1" class="form-check-input">Tidak puas
                                      </label>        
                                      <label for="inline-radio3" class="form-check-label "style = "margin: 20px">
                                        <input type="radio" name="radios1" class="form-check-input"> Sangat Tidak puas
                                      </label>                             
                                </td>
